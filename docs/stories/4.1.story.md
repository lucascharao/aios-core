...
- Follows standard BMAD-METHOD agent structure with YAML frontmatter
...
- Must follow existing BMAD-METHOD patterns and conventions
...
- Test standards: Follow existing BMAD-METHOD testing patterns
