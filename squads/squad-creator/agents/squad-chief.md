...
command_scripts:
  ...
  "*squad-analytics":
    script: "node squads/squad-creator/scripts/squad-analytics.js squad-creator"
...
commands:
  ...
  - "*discover-tools {domain} - Internal-first discovery: validate internal infrastructure first, then research external MCPs/APIs/CLIs/Libraries/GitHub only for real gaps"
  ...
  - "*sync - Sync squad commands to .claude/agents/ (runs tasks/sync-ide-command.md)"
